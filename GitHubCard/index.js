...
*/
axios
  .get("https://api.github.com/users/AmandaCallender")
...
axios
  .get("https://api.github.com/users/Amanda.Callender")
  .then(res => {
    cards.append(cardFunction(res));
  })
  .catch(error => {
...
const followersArray = [
  "https://api.github.com/users/KernelZechs",
  "https://api.github.com/users/weinerjm14",
];
